      ...
      <div class="x_panel">
        <div class="x_title">
          {{--<h2><i class="fa fa-{{$icon}}"></i> {{$title}}</h2>--}}
            ...
            <div class="x_content">
                <br>
                <form id="building_form" action="{{ isset($product->pro_id)?url('admin/edit/'.$product->pro_id):url('admin/edit') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 text-right col-md-offset-3">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> @lang('admin.save')</button>
                        </div>
                    </div>
                </form>
            </div>
